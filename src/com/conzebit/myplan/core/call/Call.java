...
public class Call extends Chargeable {
	...
	public Call(int type, Long duration, Contact contact, Calendar date, String countryWhereChargeWasMade) {
		this.type = type;
		this.duration = duration;
		this.contact = contact;
		this.date = date;
		this.countryWhereChargeWasMade = countryWhereChargeWasMade;
	}
	...
	public String toString() {
		return new StringBuilder()
			.append(Formatter.formatFullDate(this.date)).append(" - ")
			.append(this.contact).append(" - ")
			.append(this.type).append(" - ")
			.append(Formatter.formatDuration(this.duration)).append(" - ")
			.toString();
	}
}