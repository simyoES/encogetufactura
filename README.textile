...
Encogetufactura es una aplicación de código libre, desarrollada para <span style="color:#ff5900">simyo</span>, que te permite comprobar lo poco que cuesta tu factura de móvil con las tarifas de <span style="color:#ff5900">simyo</span>. Si ya eres cliente de <span style="color:#ff5900">simyo</span> podrás utilizarla para saber cuál es la tarifa que más te conviene según tu consumo, y si no lo eres todavía, podrás ver cuál sería tu factura de móvil con cada una de las tarifas disponibles. De esta manera, tanto si eres cliente, como si no lo eres, podrás descubrir cómo encoger tu factura de móvil comenzar a ahorrar sin ningún esfuerzo.

Compara lo que estás pagando con tu tarifa y operador actual con lo que pagarías con las tarifas de <span style="color:#ff5900">simyo</span> y comienza a controlar tu gasto de inmediato con la tarifa más adecuada a tus necesidades.

Esta aplicación utiliza los datos de llamadas y SMSs registrados en el terminal donde se encuentra instalada, y calcula, en base a esto, el coste que estas llamadas o SMSs tendrían con cada una de las distintas tarifas de <span style="color:#ff5900">simyo</span>.
...
Debido a la complejidad de los planes de numeración y a que el número de registros almacenados en el terminal puede ser limitado, es posible que puedan presentarse algunas discrepancias con la tarificación de numeraciones especiales, destinos internacionales, etc… y en particular con las llamadas realizadas y recibidas en roaming, ya que no se diferencian en el registro del terminal. Por esto mismo, los resultados presentados, aunque se calculan de la manera más transparente posible, siempre son aproximados y no suponen ningún carácter vinculante por parte de <span style="color:#ff5900">simyo</span>.
